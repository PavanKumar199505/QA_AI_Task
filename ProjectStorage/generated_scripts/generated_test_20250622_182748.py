...
async def scenario_checkout_process(page):
    try:
        ...
        await expect(page.locator("customer-information-form")).to_be_visible()
        await expect(page.locator("order-overview")).to_be_visible()
        await page.click("complete-checkout-button")
        await expect(page.locator("confirmation-screen")).to_be_visible()
...
async def scenario_navigation_menu(page):
    try:
        ...
        await expect(page.locator("all-items-link")).to_be_visible()
        await expect(page.locator("about-link")).to_be_visible()
        await expect(page.locator("logout-link")).to_be_visible()
        await expect(page.locator("reset-app-state-link")).to_be_visible()
...
async def scenario_social_media_links(page):
    try:
        await page.goto("https://www.saucedemo.com/")
        await expect(page.locator("social-media-links")).to_be_visible()
...
async def scenario_problem_user(page):
    try:
        await page.goto("https://www.saucedemo.com/inventory.html")
        await page.click("product-details-button")
        await expect(page.locator("ui-issues")).to_be_visible()
...
async def scenario_performance_glitch_user(page):
    try:
        ...
        await page.fill("Password", "secret_sauce")
        await page.click("login-button")
        await expect(page.locator("slow-response")).to_be_visible()
